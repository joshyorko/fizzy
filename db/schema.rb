...
ActiveRecord::Schema[8.2].define(version: 2026_05_01_000002) do
  ...
  create_table "oauth_authorization_codes", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "oauth_clients", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "scope", default: "read write", null: false
